...
2. หลังจากคุณเริ่มมีสติและเรียบเรียงเรื่องราวทุกอย่างที่เกิดขึ้นคุณก็เข้าใจโลกใบนี้ทันทีนี่คือโลกแห่ง cpp ทันใดนั้นคุณก็เห็นสไลม์ คุณได้หยิบกิ่งไม้ขึ้นมาและโจมตีไปที่มันแต่กลับไม่เป็นอะไร(ก็มันคือสไลม์อ่ะเนาะ) อยู่ๆก็มีเสียงออกมาจากหน้าต่างที่เอาไว้เขียนคำสั่งตะโกนออกมาว่า ถ้าเราโจมตีมันด้วยเลขคู่มันจะได้รับบาดเจ็บหนัก คุณจึงจัดหนักสไลม์ โดยการพิมพ์เลขคู่ตั้งแต่ 2 จนถึง 100,000 เช่น (2 4 6 8 ...)


3. หลังจากคุณจัดการสไลม์ได้แล้ว คุณพึ่งนึกได้ว่าเมื่อกี้เจ้าหน้าต่างเขียนคำสั่งมันสามารถพูดได้ คุณจึงเรียกหน้าต่างออกมาและเรียกมันดู แต่มันไม่ตอบอะไรกลับมา(มีเล่นตัวด้วย) แต่พิมพ์ข้อความกลับมาแทนว่า ฉันคือผู้ช่วยของคุณเอง พร้อมที่จะคุยด้วยเสมอ (//ขึ้น chat bot ขึ้นมา)
