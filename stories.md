...
# 5
แน่นอนว่าหลังจากคุณได้อาวุธใหม่สุดหล่อเท่ห์ คุณต้องไปแก้แค้นและเอาคืนเจ้าฝูงสไลม์ แต่กลับเจอสิ่งที่ไม่คาดฝัน มันคือบอสสไลม์ แต่ด้วยความแค้นสไลม์เป็นอย่างมากจึงได้เข้าไปโจมตี แต่ว่าก็ยังโจมตีมันไม่เข้าอยู่ดีๅ  แถมยังโดนมันโจมตีสวนกลับมาทั้งหมด n ครั้งแต่ละครั้งโจมตี $x_i$ ดาเมจ (1 <= i <=n) แต่เนื่องจากคุณมีสกิวที่สามารถหลบได้เพียงแค่ k ครั้ง จงหาว่าคุณจะเสียเลือดน้อยที่สุดเท่าใด
### input
5 3 \
2 5 1 6 4 4 3
### output
...
# 6
ด้วยความที่สไลม์โจมตีมาอย่างต่อเนื่องทำให้มันมานาหมด จังหวะนี้แหละคุณจะสวนกลับไปโดยตะโกนใส่มัน ซึ่งมันมีจุดอ่อนคือถ้าในคำพูดของคุณมีอักษรคำว่า ('s','l','i','m','e') เรียงกัน แต่ไม่จำเป็นต้องติดกัน จะทำให้มันเจ็บหนัก 
...
# 7
หลังจากจัดการเจ้าสไลม์ได้คุณก็ได้ไอเทมยาฟื้นฟูเลือด แต่ทว่ายาชวดนี้มีชื่อที่ประกอบไปด้วยตัวอักษรสองตัวคือ w และ o ประสิทธิภาพขึ้นอยู่กับชื่อของมัน โดยที่ถ้ามีคำว่า "wow" อยู่ในชื่อยามากเท่าไหร่ยิ่งมีประสิทธิภาพเท่านั้น และห้ามใช้ตัวอักษรที่ใช้ไปแล้ว จงหาว่ายาขวดนี้ประสิทธิภาพเท่าไหร่
### input
wowwowwowwowwow
### output
5
