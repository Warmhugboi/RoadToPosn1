...
บรรทัดถัดมา มี n ตัว รับค่า $x_i$ (0 <= i < n) \
...
บรรทัดถัดมา มี n จำนวน รับค่า $x_i$ (0 <= i < n)
### output
...
-9223372036854775808 <= $x_i$ <= 9223372036854775807
...
### input
บรรทัดแรก จำนวนเต็ม n \
n บรรทัดถัดมา มี m ตัวรับค่า $x_i$ (0 <= i < m)
### output
...
บรรทัดถัดมา จำนวนเต็ม n ตัว $x_i$ (0 <= i < n)
### output
...
# Sum 5 
ให้ตารางมา n แถว m หลัก โดยจะถามคุณทั้งหมด q ครั้ง ในแต่ละครั้งจะถามผลรวมตารางย่อยที่เริ่มจากแถว $a_j$ หลัก $b_j$ จนไปถึงแถว $x_j$ หลัก $y_j$ (1 <= j <= q)
### input
บรรทัดแรด จำนวนเต็ม n และ m แสดงถึง จำนวนแถว และจำนวนหลักของตาราง \
บรรทัดถัดมา จำนวนเต็ม q แสดงถึงจำนวนคำถาม \
n บรรทัดถัดมา จำนวนเต็ม m ตัว รับค่า $c_i$ (1 <= i <= m)\
q บรรทัดถัดมา จำนวนเต็ม $a_j$ $b_j$ $x_j$ และ $y_j$ แสดงตำแหน่งเริ่มต้น ($a_j$ , $b_j$) และ ตำแหน่งสุดท้ายท้าย ($x_j$ , $y_j$) โดยที่ (1 <= j <= q), (0 <= $a_j$ <= $x_j$ < n) และ (0 <= $b_j$ <= $y_j$ < m)
### output
มีทั้งหมด q บรรทัด ในแต่ละบรรทัดให้แสดงผลรวมตารางที่เริ่มจากแถว $a_i$ หลัก $b_i$ จนไปถึงแถว $x_i$ หลัก $y_i$
