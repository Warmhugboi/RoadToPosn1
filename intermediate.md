...
# Sum 5 
ให้ตารางมา n แถว m หลัก โดยจะถามคุณทั้งหมด q ครั้ง ในแต่ละครั้งจะถามผลบวกของตัวเลขตั้งแต่แถว $a_i$ หลัก $b_i$ จนไปถึงแถว $x_i$ หลัก $y_i$
### input
บรรทัดแรด จำนวนเต็ม n และ m แสดงถึง จำนวนแถว จำนวนหลักของตาราง \
บรรทัดถัดมา จำนวนเต็ม q แสดงถึงจำนวนคำถาม \
n บรรทัดถัดมา จำนวนเต็ม m ตัว \
q บรรทัดถัดมา จำนวนเต็ม $a_i$ หลัก $b_i$ $x_i$ และ $y_i$ แสดงตำแหน่งเริ่มต้น ($a_i$, $b_i$) และ ตำแหน่งสุดท้ายท้าย ($x_i$, $y_i$) (0 <= $a_i$ <=$x_i$ < n) (0 <= $b_i$ <= $y_i$ < m)
### output
มีทั้งหมด q บรรทัด ในแต่ละบรรทัดให้แสดงผลรวมตั้งแต่ตัวที่ l ถึง r
