...
เนื่องจากว่านนซ่า007 เป็นคนที่ชอบ cola เป็นอย่างมาก จึงอยากถามคุณทั้งหมด q ครั้ง ในแต่ละครั้ง หากนนซ่า007 มีเงินทั้งหมด $y_i$ บาท \
จงหาว่าเขาจะสามารถซื้อ cola ได้มากที่สุดกี่กระป๋อง 
### input
...
q บรรทัดถัดมา จำนวนเต็ม $y_i$ แสดงถึงจำนวนเงินที่นนซ่า007 มี
### output
