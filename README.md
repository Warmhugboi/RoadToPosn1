...
อยู่ก่อนหน้ามันตัวเดียวนั่นเอง ส่วนวิธีการเขียนมีดังนี้
        ...
        int fibo(int n){
            ...
            return value;
            เหตุผลเพราะในการ recur ของโค้ด โปรแกรมจะเรียกฟังชั่นไปเรื่อยๆจนถึง base-case ซึ่งสังเกตุว่าก่อนถ้า int value จะถูกรีเทิร์นไป จะมีการเรียกฟังชั่นเดิมซ้ำ และสร้าง int value เป็นเช่นนี้ซ้ำไปเรื่อยๆ
            ในกรณีที่เลวร้ายอาจทำให้ int value ถูกสร้างขึ้นมาเยอะมากๆ จนทำให้ memory เกินขอบเขตที่รับไหว จนทำให้ไม่ได้คะแนน หรือ โปรแกรมแครชได้
            */
            // วิธีที่แนะนำ
