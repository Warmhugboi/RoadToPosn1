...
[https://youtu.be/F70RaGIOcUs](https://youtu.be/F70RaGIOcUs)
...
- if ไว้ใช้เป็นเงื่อนไขแรก
- else if ไว้ใช้เป็นเงื่อนไขถัดๆมา ถ้าตัวก่อนหน้าไม่เป็นจริง
- else ไว้ใช้เป็นเงื่อนไขนอกเหนือจากตัวทั้งหมดก่อนหน้า
...
วิธีประกาศค่า
    ...
    string st = "ILoveTNTGradering.com";    // ได้เรื่อยๆ ไม่มีจำกัด
    
    // หรือ
    int n = 10 ;
    string st(n, 'D');      // กำหนดให้ตั้งแต่ index ที่ 0 ถึง n - 1 เป็น 'D'
